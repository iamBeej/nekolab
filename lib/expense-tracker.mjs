...
function normalizeCategory(category) {
  ...
  if (!normalizedCategory) {
    throw new ExpenseCommandError("Missing required field 'category'");
  }
...
function normalizeNotes(notes) {
  ...
  if (!normalizedNotes) {
    throw new ExpenseCommandError("Missing required field 'notes'");
  }
...
async function addExpense(fields) {
  ensureNoUnexpectedFields(
    fields,
    new Set(["person", "category", "amount", "item", "notes"]),
  );
